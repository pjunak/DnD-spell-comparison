...
- name: Rend
  description: 'Melee Attack Roll: +13, reach 10 ft. Hit: 17 (2d8 + 8) Slashing damage
    plus 4 (1d8) Cold damage.'
- name: "Cold Breath (Recharge 5\u20136)"
  description: 'Constitution Saving Throw: DC 20, each creature in a 60-foot Cone.
...
- name: Cold Gale
  description: "Dexterity Saving Throw: DC 19, each creature in a 60-foot-long, 10-foot-wide\
