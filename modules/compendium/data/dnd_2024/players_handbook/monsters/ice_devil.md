...
- name: Magic Resistance
  description: The imp has Advantage on saving throws against spells and other magical
    effects.
actions:
- name: Sting
...
- name: Shape-Shift
  description: "The imp shape-shifts to resemble a rat (Speed 20 ft.), a raven (20\
