...
traits:
- name: Immunities
  description: Acid; Prone
- name: Adhesive (Object Form Only)
  description: The mimic adheres to anything that touches it. A Huge or smaller creature
    adhered to the mimic has the Grappled condition (escape DC 13). Ability checks
