...
def setup_logging(app_name: str = "SpellGraphix", debug: bool = False, enabled: bool = True) -> None:
    """Configure root logger with console and rotating file handlers.
    
    Args:
        app_name: Name of the application (used for directory naming).
        debug: If True, set log level to DEBUG, else INFO.
        enabled: If False, disable all logging.
    """
    ...
    if not enabled:
        ...
        root_logger.setLevel(logging.CRITICAL + 1) # Effectively disable logging
        return
    ...
    # Handlers cleared at start of function
